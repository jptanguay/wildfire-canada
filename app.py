...
st.write(
    """
    Source: La Base nationale de données sur les feux de forêt du Canada (BNDFFC) 
    
    :heavy_exclamation_mark: Note: Les superficies sont en hectares
    """
...
with st.container(border=True):
    ...
    "Sélectionnez la juridiction dans le panneau latéral"
